 ...
 */
function binbill_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Bin Bill default saturation level.
	 *
	 * @since Bin Bill 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'binbill_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.binbill-front-page) .entry-title,
...
.colors-custom .binbill-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.binbill-front-page .panel-content .recent-posts article,
...
.colors-custom.binbill-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Bin Bill custom colors CSS.
	 *
	 * @since Bin Bill 1.0
	 *
	 ...
	 */
	return apply_filters( 'binbill_custom_colors_css', $css, $hue, $saturation );
}
